function [FX, FY, T] = cl_forces_hanpeskin_new(FX_IN, FY_IN, X_IN, Y_IN, N_w, N_pairs, dt, T_IN, cl_el)
...
for i_pairs=1:N_pairs
    for i=1:(N_w - 1)
            ...
            T_x = T_OUT(seg_a) * cos_alpha;
            T_y = T_OUT(seg_a) * sin_alpha;
            ...
            % Passive cross-links in other direction
            [FX, FY] = add_spring_force_between_segments(FX, FY, X_IN, Y_IN, i + 1, N_w + i, 5, cl_el); 
